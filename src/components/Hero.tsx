...
export function Hero() {
  ...
  return (
    <div className="hero-panel px-0 py-8 lg:px-[clamp(1.75rem,4.5vw,4.75rem)] lg:py-4">
      ...
      <div className="hero-content-wrapper lg:px-0">
        ...
        <div className="hero-eyebrow mb-3 inline-flex items-center border border-ink pr-2.5 font-mono text-[0.66rem] uppercase lg:mb-2">
        ...
        <p className="hero-copy mt-4 max-w-180 text-[clamp(1.08rem,1.7vw,1.42rem)] leading-normal lg:mt-3 lg:text-[clamp(1rem,1.2vw,1.15rem)]">
        ...
        <div className="subscribe-block mt-4 max-w-190 lg:mt-3">
